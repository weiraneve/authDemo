package com.weiran.token.config.mybatis;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.weiran.token.mapper", sqlSessionFactoryRef = "adminSqlSessionFactory")
public class AdminSessionFactoryConfiguration {
    ...
    public SqlSessionFactory activitySqlSessionFactory(@Qualifier("adminDataSource") DataSource dataSource) throws Exception {
        ...
        sfb.setTypeAliasesPackage("com.weiran.token.entity");
