//package com.weiran.auth.mybatis;
//
...
//        gc.setOutputDir(projectPath + "/satokenDemo/com.weiran.satoken.basic.satoken-basic" + "/src/main/java");
//        // TODO 设置用户名
//        gc.setAuthor("Weiran");
//        gc.setOpen(false);
//        // service 命名方式
...
//        dsc.setUrl("jdbc:mysql://localhost:3306/auth?useUnicode=true&useSSL=false&characterEncoding=utf8");
...
//                return projectPath + "/satokenDemo/com.weiran.satoken.basic.satoken-basic" + "/src/main/resources/mapper/" + pc.getModuleName()
...
//                return projectPath + "/satokenDemo/com.weiran.satoken.basic.satoken-basic" + "/src/main/java/com/weiran/auth/model/" + pc.getModuleName()
//                        + tableInfo.getEntityName() + StringPool.DOT_JAVA;
//            }
//        });
...
//                return projectPath + "/satokenDemo/com.weiran.satoken.basic.satoken-basic" + "/src/main/java/com/weiran/auth/mapper/"
//                        + tableInfo.getEntityName().substring(0, tableInfo.getEntityName().length() - 2) + "Mapper" + StringPool.DOT_JAVA;
//            }
//        });
...
//                return projectPath + "/satokenDemo/com.weiran.satoken.basic.satoken-basic" + "/src/main/java/com/weiran/auth/manager/"
//                        + tableInfo.getEntityName().substring(0, tableInfo.getEntityName().length() - 2) + "Manager" + StringPool.DOT_JAVA;
//            }
//        });
...
//                return projectPath + "/satokenDemo/com.weiran.satoken.basic.satoken-basic" + "/src/main/java/com/weiran/auth/manager/impl/"
//                        + tableInfo.getEntityName().substring(0, tableInfo.getEntityName().length() - 2) + "ManagerImpl" + StringPool.DOT_JAVA;
//            }
//        });
...
//                return projectPath + "/satokenDemo/com.weiran.satoken.basic.satoken-basic" + "/src/main/java/com/weiran/auth/controller/"
//                        + tableInfo.getEntityName().substring(0, tableInfo.getEntityName().length() - 2) + "Controller" + StringPool.DOT_JAVA;
//            }
//        });
