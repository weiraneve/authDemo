...
//        gc.setOutputDir(projectPath + "/satokenDemo/satoken-basic" + "/src/main/java");
//        // TODO 设置用户名
//        gc.setAuthor("Weiran");
//        gc.setOpen(false);
//        // service 命名方式
...
//                return projectPath + "/satokenDemo/satoken-basic" + "/src/main/resources/mapper/" + pc.getModuleName()
...
//                return projectPath + "/satokenDemo/satoken-basic" + "/src/main/java/com/weiran/auth/model/" + pc.getModuleName()
//                        + tableInfo.getEntityName() + StringPool.DOT_JAVA;
//            }
//        });
...
//                return projectPath + "/satokenDemo/satoken-basic" + "/src/main/java/com/weiran/auth/mapper/"
//                        + tableInfo.getEntityName().substring(0, tableInfo.getEntityName().length() - 2) + "Mapper" + StringPool.DOT_JAVA;
//            }
//        });
...
//                return projectPath + "/satokenDemo/satoken-basic" + "/src/main/java/com/weiran/auth/manager/"
//                        + tableInfo.getEntityName().substring(0, tableInfo.getEntityName().length() - 2) + "Manager" + StringPool.DOT_JAVA;
//            }
//        });
...
//                return projectPath + "/satokenDemo/satoken-basic" + "/src/main/java/com/weiran/auth/manager/impl/"
//                        + tableInfo.getEntityName().substring(0, tableInfo.getEntityName().length() - 2) + "ManagerImpl" + StringPool.DOT_JAVA;
//            }
//        });
...
//                return projectPath + "/satokenDemo/satoken-basic" + "/src/main/java/com/weiran/auth/controller/"
//                        + tableInfo.getEntityName().substring(0, tableInfo.getEntityName().length() - 2) + "Controller" + StringPool.DOT_JAVA;
//            }
//        });
